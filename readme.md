...
(async () => {
  ...
  const dateIntervals = [
    { before: '2025-01-01', label: '2025年以前' },
    { after: '2025-01-01', before: '2026-01-01', label: '2025年' },
    { after: '2026-01-01', before: '2027-01-01', label: '2026年' },
    { after: '2027-01-01', before: '2028-01-01', label: '2027年' },
    { after: '2028-01-01', label: '2028年及以後' }
  ];
